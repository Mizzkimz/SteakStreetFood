...
public class Level3_Stage extends JPanel implements ActionListener {
    ...
    private ImageIcon porkwithpan2 = new ImageIcon(this.getClass().getResource("Porkwithpan.png"));
    private ImageIcon fishwithpan2 = new ImageIcon(this.getClass().getResource("Fishwithpan.png"));
    ...
    public JButton Pan4BT = new JButton(pan);
    
    public JButton PorkPan1BT = new JButton(porkwithpan);
    public JButton FishPan1BT = new JButton(fishwithpan);
    public JButton PorkPan2BT = new JButton(porkwithpan2);
    public JButton FishPan2BT = new JButton(fishwithpan2);
    ...
    public Level3_Stage() {
        ...
        setLayout(null);
        Pan3BT.setBounds(244,490, 292, 187);;
        ...
        setLayout(null);
        Pan4BT.setBounds(244,346, 292, 187);;
        Pan4BT.setBorderPainted(false);
        Pan4BT.setBorder(null);
        Pan4BT.setOpaque(false);
        Pan4BT.setContentAreaFilled(false);
        add(Pan4BT);
        Pan4BT.addActionListener(this);
    ...
    public void paintComponent(Graphics g){
        ...
        g.fillOval(415,615, 30, 30);
        g.fillOval(415,462, 30, 30);
        
        g.setColor(Color.BLACK);
        g.drawOval(630,615, 30, 30);
        g.drawOval(630,462, 30, 30);
        g.drawOval(415,615, 30, 30);
        g.drawOval(415,462, 30, 30);
        
        g.setColor(Color.BLACK); 
        g.drawString(""+checktimepan1, 640,638);
        g.drawString(""+checktimepan2, 640,485);
        g.drawString(""+checktimepan3, 425,638);
        g.drawString(""+checktimepan4, 425,485);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == PorkBT){
            if(checkpan1 == false && checkpan3 == false){
                this.remove(Pan1BT);
                setLayout(null);
            ...
            else if(checkpan1 == true && checkpan3 == false){
                this.remove(Pan3BT);
                setLayout(null);
                PorkPan2BT.setBounds(244,490, 292, 187);
                PorkPan2BT.setBorderPainted(false);
                PorkPan2BT.setBorder(null);
                PorkPan2BT.setOpaque(false);
                PorkPan2BT.setContentAreaFilled(false);
                add(PorkPan2BT);
                PorkPan2BT.addActionListener(this);
                checkpan3 = true;
            }
            else if(checkpan1 == false && checkpan3 == true){
                this.remove(Pan1BT);
                setLayout(null);
                PorkPan1BT.setBounds(460,490, 292, 187);
                PorkPan1BT.setBorderPainted(false);
            ...
            if(checkpan2 == false && checkpan4 == false){
                this.remove(Pan2BT);
                setLayout(null);
            ...
            else if(checkpan2 == true && checkpan4 == false){
                this.remove(Pan4BT);
                setLayout(null);
                FishPan2BT.setBounds(244,346, 292, 187);
                FishPan2BT.setBorderPainted(false);
                FishPan2BT.setBorder(null);
                FishPan2BT.setOpaque(false);
                FishPan2BT.setContentAreaFilled(false);
                add(FishPan2BT);
                FishPan2BT.addActionListener(this);
                checkpan4 = true;
            }
            else if(checkpan2 == false && checkpan4 == true){
                this.remove(Pan2BT);
                setLayout(null);
                FishPan1BT.setBounds(460,346, 292, 187);
                FishPan1BT.setBorderPainted(false);
        ...
        else if(e.getSource() == PorkPan2BT){
            if(checktimepan3 <= 0 ){
                    this.remove(PorkPan2BT);
                    setLayout(null);
                    PorkSteakPlate1BT.setBounds(700,530, 292, 187);
                    PorkSteakPlate1BT.setBorderPainted(false);
                    PorkSteakPlate1BT.setBorder(null);
        ...
        else if(e.getSource() == FishPan2BT){
            if(checktimepan4 <= 0 ){
                this.remove(FishPan2BT);
                    setLayout(null);
                    FishSteakPlate1BT.setBounds(700,340, 292, 187);
                    FishSteakPlate1BT.setBorderPainted(false);
                    FishSteakPlate1BT.setBorder(null);
